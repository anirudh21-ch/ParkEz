#!/usr/bin/env python3
"""
Simple test script for license plate OCR using the uploaded images
This script doesn't require OpenCV or other complex dependencies
"""
...
logger = logging.getLogger('simple_test_ocr')

# OCR API configuration - use the existing simple_license_plate_ocr.py service
