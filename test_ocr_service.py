...
def test_ocr_service(image_path, api_url="http://localhost:5004/scan"):
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python test_ocr_service.py <image_path> [api_url]")
        sys.exit(1)
    ...
    api_url = sys.argv[2] if len(sys.argv) > 2 else "http://localhost:5004/scan"
    
    # Test the OCR service
    test_ocr_service(image_path, api_url)
